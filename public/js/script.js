...
const DRIVE_UPLOAD_URL = "https://abigengineform.onrender.com/upload";
const SHEET_SUBMIT_URL = "https://abigengineform.onrender.com/submit";
...
async function submitForm() {
 ...
 try {
    ...
    document.querySelectorAll('.btn-service.active').forEach(btn => btn.classList.remove('active'));
